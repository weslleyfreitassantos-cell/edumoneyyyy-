...
export function AuthShell({
  ...
  if (layoutVariant === 'login') {
    ...
    if (!showHero) {
      return (
        <div className={`min-h-dvh font-sans ${shellBg} flex flex-col items-center justify-center px-4 py-8`} style={{ backgroundImage: 'url(/media/ff2.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
