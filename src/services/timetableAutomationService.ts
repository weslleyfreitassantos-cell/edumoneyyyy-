...
export const timetableAutomationService = {
  ...
  async generateDraft(input: { institutionId: string; academicYearId: string; createdBy: string; seed?: string; name?: string }): Promise<GeneratedDraft> {
