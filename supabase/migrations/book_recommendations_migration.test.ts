...
const migration = readFileSync(
  resolve(process.cwd(), 'supabase/migrations/20260909000900_book_recommendations.sql'),
  'utf8',
);

const migrationFileName = '20260909000900_book_recommendations.sql';
...
describe('book recommendations migration', () => {
  it('uses the next unique migration version after the learning center chain', () => {
    expect(migrationFileName).toBe('20260909000900_book_recommendations.sql');
    ...
    expect(
      migrationFiles.filter((fileName) => fileName.startsWith('20260909000900_')),
